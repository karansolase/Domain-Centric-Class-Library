...
class Shape_Traingular_Pyramid;
class Shape_Rectangle;
class Shape_Rectangular_Pyramid;
class Shape_Square;
class Shape_Square_Pyramid;

class Measurement_and_unit{

    friend class Shape_Rectangle;
    friend class Shape_Traingle;
    friend class Shape_Square;
    friend class Shape_Traingular_Pyramid;
    friend class Shape_Rectangular_Pyramid;
    friend class Shape_Square_Pyramid; 

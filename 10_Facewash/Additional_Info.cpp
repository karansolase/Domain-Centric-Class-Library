...
std::ostream& operator<<(std::ostream& os, const Additional_Info& Additional_Info_Object){
    ...
    os << "ASIN : "         << Additional_Info_Object.Add_Info_ASIN     << std::endl << std::endl
       << "Manufacturer : " << Additional_Info_Object.Add_Info_Manufacturing_Object  << std::endl
       ...
       Additional_Info_Object.Add_Info_Warranty.begin();

       while(Iter_1 != Additional_Info_Object.Add_Info_Warranty.end())
       {
        j = j + 1;
        std::cout << j << ") " << *Iter_1 << std::endl;
        ++Iter_1;
       }

       os << "Country of Origin : " << Additional_Info_Object.Add_Info_Country_Of_Origin << std::endl
       ...
       << "Packer : "       << Additional_Info_Object.Add_Info_Packer_Object << std::endl
       << "Importer : "     << Additional_Info_Object.Add_Info_Importer_Object << std::endl 
       << "Included Components : ";

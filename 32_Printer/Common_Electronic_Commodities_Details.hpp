...
class Common_Electronic_Commodities_Details
{
    ...
    std::string CECD_Human_Interface_Input;
    Word_Number CECD_Processor; 
    std::vector <Word_Number> CECD_OperatingSystem;
    ...
    std::vector <Word_Number> CECD_HardwareInterface;
...
#endif /* Common_Electronic_Commodities_Details.hpp */